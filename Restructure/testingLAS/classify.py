...
for filename in os.listdir():
	if "Infty" in filename and filename[:4]=="attr" and "T200" in filename:
		...
		pylon =  (inFile.iso >= 0.6) & (inFile.iso < 0.75) & (inFile.ang2 < 0.1) & (inFile.eig0 < 0.25) & (inFile.linearity > 0.1) & (inFile.eigent > 0.2)
